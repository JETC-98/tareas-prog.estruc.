...
/*No se usa la variable "totalventas" declarada al inicio como int,al no declarar como 0 
las variables del pago con tarjeta hace que te den cantidades exorbitantes a la hora de dar resultados*/
//Josue Torres
