...
// Funciona bien
// Al ya tener el nombre del empleado, se podría poner para que lo ponga en lugar de poner que número de empleado es
/*Dime el nombre del trabajador Numero 1: Alejandro
	Dime la antiguedad que tiene: 2
	Dime el sueldo del trabajador 1: <---
*/
